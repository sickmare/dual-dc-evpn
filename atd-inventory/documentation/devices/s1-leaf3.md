...
| Ethernet4 | SERVER_s1-leaf3_s1-leaf4-L2_VPC1_NIC1 | *trunk | *20 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s1-spine1_Ethernet4 | - | 172.30.255.49/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s1-spine2_Ethernet4 | - | 172.30.255.51/31 | default | 1500 | False | - | - |
| Ethernet6 | test eth6 routed port | - | 10.192.36.254/24 | bluevrf | - | False | - | - |
...
!
interface Ethernet4
   description SERVER_s1-leaf3_s1-leaf4-L2_VPC1_NIC1
   no shutdown
...
| Port-Channel4 | PortChannel | trunk | 20 | - | - | - | - | 4 | - |
...
router bgp 65102
   ...
   neighbor 10.255.251.25 description s1-leaf4_Vlan4093
   ...
   vrf bluevrf
      ...
      router-id 192.0.255.15
      neighbor 10.255.251.25 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.25 description s1-leaf4_Vlan3009
