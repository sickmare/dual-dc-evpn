...
| --------- | --------------- | ------------ | --------- |
| pod21 | Vlan4094 | 10.222.252.40 | Port-Channel1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet3 | routed | - | 172.32.255.85/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet3 | routed | - | 172.32.255.87/31 | default | 1500 | False | - | - |
| Ethernet6 | test eth6 routed port | routed | - | 10.192.226.254/24 | bluevrf | 9000 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.2.255.24/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.2.254.23/32 |
| Loopback100 | bluevrf_VTEP_DIAGNOSTICS | bluevrf | 10.255.1.24/32 |
...
| Vlan3009 |  bluevrf  |  10.222.251.41/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.222.251.41/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.222.252.41/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.222.251.40 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.32.255.84 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.32.255.86 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.222.251.40 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | bluevrf | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 192.2.255.24:30020 | 30020:30020 | - | - | learned |
| 30 | 192.2.255.24:30030 | 30030:30030 | - | - | learned |
| 2300 | 192.2.255.24:32300 | 32300:32300 | - | - | learned |
| 2301 | 192.2.255.24:32301 | 32301:32301 | - | - | learned |
...
router bgp 65201
   ...
   neighbor 10.222.251.40 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.222.251.40 description s2-leaf1
   neighbor 172.32.255.84 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.84 remote-as 65002
   neighbor 172.32.255.84 description s2-spine1_Ethernet3
   neighbor 172.32.255.86 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.86 remote-as 65002
   neighbor 172.32.255.86 description s2-spine2_Ethernet3
