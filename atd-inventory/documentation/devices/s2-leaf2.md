...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet3 | - | 172.32.255.85/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet3 | - | 172.32.255.87/31 | default | 1500 | False | - | - |
| Ethernet6 | test eth6 routed port | - | 10.192.226.254/24 | bluevrf | - | False | - | - |
...
router bgp 65201
   ...
   neighbor 10.222.251.40 description s2-leaf1_Vlan4093
   ...
   vrf bluevrf
      ...
      router-id 192.2.255.24
      neighbor 10.222.251.40 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.222.251.40 description s2-leaf1_Vlan3009
