...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-brdr1_Ethernet4 | - | 172.16.30.5/31 | default | 9214 | False | - | - |
| Ethernet4 | TO DC1 s1-core1 eth4 | - | 30.1.1.2/24 | default | - | False | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 30.1.1.1 | 65300 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65301
   ...
   neighbor 30.1.1.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 30.1.1.1 remote-as 65300
   neighbor 172.16.30.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.30.4 remote-as 65203
   neighbor 172.16.30.4 description s2-brdr1
