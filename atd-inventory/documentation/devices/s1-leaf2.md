...
| --------- | --------------- | ------------ | --------- |
| pod1 | Vlan4094 | 10.255.252.20 | Port-Channel1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s1-spine1_Ethernet3 | - | 172.30.255.45/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s1-spine2_Ethernet3 | - | 172.30.255.47/31 | default | 1500 | False | - | - |
| Ethernet6 | test eth6 routed port | - | 10.192.26.254/24 | bluevrf | - | False | - | - |
...
| 172.30.255.44 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.30.255.46 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.251.20 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | bluevrf | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 10.255.251.20 description s1-leaf1_Vlan4093
   ...
   vrf bluevrf
      ...
      router-id 192.0.255.14
      neighbor 10.255.251.20 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.20 description s1-leaf1_Vlan3009
