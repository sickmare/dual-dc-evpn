...
| Ethernet4 | s2-leaf3_s2-leaf4-L2_VPC1_NIC2 | *trunk | *20 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet5 | routed | - | 172.32.255.93/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet5 | routed | - | 172.32.255.95/31 | default | 1500 | False | - | - |
| Ethernet6 | test eth6 routed port | routed | - | 10.192.246.254/24 | bluevrf | 9000 | False | - | - |
...
| Port-Channel4 | s2-leaf3_s2-leaf4-L2_VPC1_PortChannel | switched | trunk | 20 | - | - | - | - | 4 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.2.255.26/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.2.254.25/32 |
| Loopback100 | bluevrf_VTEP_DIAGNOSTICS | bluevrf | 10.255.1.26/32 |
