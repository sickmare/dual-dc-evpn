...
| --------- | --------------- | ------------ | --------- |
| pod22 | Vlan4094 | 10.222.252.44 | Port-Channel1 |
...
| Ethernet4 | SERVER_s2-leaf3_s2-leaf4-L2_VPC1_NIC2 | *trunk | *20 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet5 | - | 172.32.255.93/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet5 | - | 172.32.255.95/31 | default | 1500 | False | - | - |
| Ethernet6 | test eth6 routed port | - | 10.192.246.254/24 | bluevrf | - | False | - | - |
...
!
interface Ethernet4
   description SERVER_s2-leaf3_s2-leaf4-L2_VPC1_NIC2
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.2.255.26/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.2.254.25/32 |
| Loopback100 | DIAG_VRF_bluevrf | bluevrf | 10.255.1.26/32 |
...
| Vlan3009 |  bluevrf  |  10.222.251.45/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.222.251.45/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.222.252.45/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.222.251.44 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 172.32.255.92 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.32.255.94 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.222.251.44 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | bluevrf | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 192.2.255.26:30020 | 30020:30020 | - | - | learned |
| 30 | 192.2.255.26:30030 | 30030:30030 | - | - | learned |
| 2300 | 192.2.255.26:32300 | 32300:32300 | - | - | learned |
| 2301 | 192.2.255.26:32301 | 32301:32301 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| bluevrf | 192.2.255.26:10 | connected |
...
router bgp 65202
   ...
   neighbor 10.222.251.44 description s2-leaf3_Vlan4093
   ...
   vrf bluevrf
      ...
      router-id 192.2.255.26
      neighbor 10.222.251.44 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.222.251.44 description s2-leaf3_Vlan3009
