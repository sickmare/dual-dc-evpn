...
| --------- | --------------- | ------------ | --------- |
| pod22 | Vlan4094 | 10.222.252.45 | Port-Channel1 |
...
| Ethernet4 | s2-leaf3_s2-leaf4-L2_VPC1_NIC1 | *trunk | *20 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet4 | routed | - | 172.32.255.89/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet4 | routed | - | 172.32.255.91/31 | default | 1500 | False | - | - |
| Ethernet6 | test eth6 routed port | routed | - | 10.192.236.254/24 | bluevrf | 9000 | False | - | - |
...
interface Ethernet3
   ...
   mtu 1500
   no switchport
   ip address 172.32.255.91/31
!
interface Ethernet4
   description s2-leaf3_s2-leaf4-L2_VPC1_NIC1
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.2.255.25/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.2.254.25/32 |
| Loopback100 | bluevrf_VTEP_DIAGNOSTICS | bluevrf | 10.255.1.25/32 |
...
| 172.32.255.88 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.32.255.90 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 192.2.255.25:30020 | 30020:30020 | - | - | learned |
| 30 | 192.2.255.25:30030 | 30030:30030 | - | - | learned |
| 2300 | 192.2.255.25:32300 | 32300:32300 | - | - | learned |
| 2301 | 192.2.255.25:32301 | 32301:32301 | - | - | learned |
...
router bgp 65202
   ...
   neighbor 10.222.251.45 description s2-leaf4
   neighbor 172.32.255.88 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.88 remote-as 65002
   neighbor 172.32.255.88 description s2-spine1_Ethernet4
   neighbor 172.32.255.90 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.90 remote-as 65002
   neighbor 172.32.255.90 description s2-spine2_Ethernet4
