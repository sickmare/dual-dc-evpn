...
| Ethernet4 | SERVER_s2-leaf3_s2-leaf4-L2_VPC1_NIC1 | *trunk | *20 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet4 | - | 172.32.255.89/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet4 | - | 172.32.255.91/31 | default | 1500 | False | - | - |
| Ethernet6 | test eth6 routed port | - | 10.192.236.254/24 | bluevrf | - | False | - | - |
...
!
interface Ethernet4
   description SERVER_s2-leaf3_s2-leaf4-L2_VPC1_NIC1
   no shutdown
...
router bgp 65202
   ...
   neighbor 10.222.251.45 description s2-leaf4_Vlan4093
   ...
   vrf bluevrf
      ...
      router-id 192.2.255.25
      neighbor 10.222.251.45 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.222.251.45 description s2-leaf4_Vlan3009
